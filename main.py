...
if st.session_state.get('authentication_status'):
    ...
    st.write("**The purpose of the educational information in the responses that are generated is to foster discussions between people. It is these conversations that help with the evolution and implementation of best practices.")
